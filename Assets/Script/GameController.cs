...
public class GameController : MonoBehaviour
{
    ...
    private bool orangeColorSetted, redColorSetted; //booleani per capire se � cambiato colore
    ...
    {
        /*Otteniamo i minuti: 
            * timeSettingsInMinutes ci d� il tempo in secondi (ci serve in secondi perch� la variabile secondsToSubstract � in secondi)
            * timeSettingsInMinutes - secondsToSubstract ci d� il tempo rimanente in secondi 
        ...
        //Aggiungiamo 1 secondo ogni volta cos� possiamo utilizzarlo per sottrarre il totale dei secondi dal tempo indicato dall'utente
    ...
    void UpdateTimerImage()
    {
        ...
        /*
         * (time / (timeSettingsInMinutes): se time � il tempo passato dal momento dell'avvio del timer ad ora (in secondi), e timeSettingsInMinutes * 60f � il tempo indicato dall'inspector 
         * in secondi
    ...
    void AssignColor()
    {
        //Se ancora non � diventata arancione e il suo riempimento � compreso nei suoi 2/3
        ...
        else if (timerImage.fillAmount <= redTrigger) //se il suo riempimento � nell'ultima porzione
        {
